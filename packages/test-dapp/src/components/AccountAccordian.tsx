...
const AccountAccordian: React.FC<AccountAccordianProps> = (props: AccountAccordianProps) => {
    ...
    // const listicles = [];
    // if(props.providerData.sessions.browser_extension !== undefined){
    //     listicles.concat()
    // }
    
    return (
       <Accordion.Item eventKey={props.providerData.uid}>
           <Accordion.Header>{props.providerData.uid}</Accordion.Header>
       </Accordion.Item>
    )
}
